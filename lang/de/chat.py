...
if __name__ == '__main__':
    ...
    user_messages = list()
    all_messages = list()
    print('Beschreiben Sie Ihre Symptome dem Anmelde-Bot. Geben Sie DONE ein, wenn Sie fertig sind.')
    ...
    print('\n\nNotizversion des Gesprächs:\n\n%s' % notes)
    save_file('logs/log_%s_notes.txt' % time(), notes)
    
    ## GENERATING REPORT

    print('\n\nGenerierung des Hypothesenberichts')
    conversation = list()
    ...
    print('\n\nVorbereitung auf die klinische Bewertung')
    conversation = list()
    ...
    print('\n\nGenerierung von Überweisungen und Tests')
    conversation = list()
