...
if __name__ == '__main__':
    ...
    user_messages = list()
    all_messages = list()
    print('Опишіть свої симптоми боту реєстрації. Введіть DONE, коли закінчите.')
    ...
    print('\n\nВерсія розмови в нотатках:\n\n%s' % notes)
    save_file('logs/log_%s_notes.txt' % time(), notes)
    
    ## GENERATING REPORT

    print('\n\nГенерація звіту про гіпотези')
    conversation = list()
    ...
    print('\n\nПідготовка до клінічної оцінки')
    conversation = list()
    ...
    print('\n\n Генерація направлень та тестів')
    conversation = list()
