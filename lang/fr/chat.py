...
if __name__ == '__main__':
    ...
    user_messages = list()
    all_messages = list()
    print('Décrivez vos symptômes au bot d\'admission. Tapez DONE lorsque vous avez terminé.')
    ...
    print('\n\nGénération de notes d\'admission')
    conversation = list()
    ...
    print('\n\nVersion de notes de la conversation:\n\n%s' % notes)
    save_file('logs/log_%s_notes.txt' % time(), notes)
    
    ## GENERATING REPORT

    print('\n\nGénération du rapport d\'hypothèses')
    conversation = list()
    ...
    print('\n\nPréparation à l\'évaluation clinique')
    conversation = list()
    ...
    print('\n\nGénération de renvois et de tests')
    conversation = list()
