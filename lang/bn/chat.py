...
if __name__ == '__main__':
    ...
    user_messages = list()
    all_messages = list()
    print('আপনার লক্ষণগুলি আপনার স্থান্তরণ বটে বর্ণনা করুন। শেষ হলে DONE টাইপ করুন।')
    ...
    print('\n\n কথোপকথনের নোট সংস্করণ:\n\n%s' % notes)
    save_file('logs/log_%s_notes.txt' % time(), notes)
    
    ## GENERATING REPORT

    print('\n\nহাইপোথেসিস রিপোর্ট তৈরি করা')
    conversation = list()
    ...
    print('\n\nক্লিনিকাল মূল্যায়নের জন্য প্রস্তুতি')
    conversation = list()
