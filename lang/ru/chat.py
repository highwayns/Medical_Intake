...
if __name__ == '__main__':
    ...
    user_messages = list()
    all_messages = list()
    print('Опишите свои симптомы боту приема. Введите DONE, когда закончите.')
    ...
    print('\n\nЗаметки версии разговора:\n\n%s' % notes)
    save_file('logs/log_%s_notes.txt' % time(), notes)
    
    ## GENERATING REPORT

    print('\n\n Генерация отчета о гипотезах')
    conversation = list()
    ...
    print('\n\nПодготовка к клинической оценке')
    conversation = list()
